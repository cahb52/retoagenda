...
class EventManager {
    ...
    sessionError(){
      ...
      window.location.href = 'http://localhost:8080/index.html' //Redireccionar si no existe sesión iniciada
    }
      ...
      var d = new Date();
        ...
        cerrarSesion(){
          ...
          $.post(url, data, (response) => {
            if(response == "logout"){
              window.location.href="http://localhost:8080/index.html" //url a redireccionar
            }else{
