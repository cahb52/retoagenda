...
//Verificar si no existe la base de adtos al comparar que la respuesta del servidor sea iguale a 1049
  $conexion['msg'] = "Creando base de datos ".$con->database;
  $database = $con->newDatabase();
  //Ejecutar función crear base de datos
    if ($database != "OK"){ //Si la respuesta no es igual a ok
